...
각 항목은 title(프로그램명 또는 인정 교과목명), organizer(주관부서 또는 운영기관), year(이수년도), term(학기), completedAt(명확한 날짜가 있을 때 YYYY-MM-DD), hours(이수시간), credits(인정학점), certificationArea를 가집니다. 시간 자료는 hours만, 학점 자료는 credits만 채우세요.
인증영역은 인성, 글로벌, 창의, AI, 인턴십 중 하나입니다. 파일 문맥의 기본 인증영역은 ${fallbackArea}입니다.
화면 유형별로 다음 기준을 반드시 적용하세요.
- AI 인증: "교과" 표의 과목명·학점은 credits로, "비교과" 표의 프로그램명·이수시간은 hours로 각각 AI 항목에 포함합니다.
- 창의 인증: 이수년도·역량구분·프로그램명·주관부서·이수시간 행을 각각 창의 항목으로 추출합니다.
- 인성 인증: 사회봉사영역 행은 "기관 - 봉사유형"을 title로, 기관을 organizer로, 봉사시간을 hours로 추출합니다.
- 인턴십 인증: "교과" 표의 과목명·학점은 credits로, "비교과" 표의 프로그램명·이수시간은 hours로 각각 인턴십 항목에 포함합니다. 왼쪽 취득현황 합계는 개별 항목으로 만들지 마세요.
- 글로벌 인증: "국제어수업" 표의 교과목명·학점은 credits로, "글로벌 체험학습 프로그램" 표의 프로그램명·이수시간은 hours로 각각 글로벌 항목에 포함합니다.
